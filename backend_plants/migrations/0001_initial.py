    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend_plants.action')),
                ('moderator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='moderator_id', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plant_class', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subclasses', to='backend_plants.plant_class')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='plant',
            name='plant_subclass',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='backend_plants.plant_subclass'),
        ),
        migrations.AddField(
            model_name='collection',
            name='recommendation',
